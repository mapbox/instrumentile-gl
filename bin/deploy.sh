...
(cd $(dirname $0)/../ && \
    npm run build && \
    aws s3 cp --content-type="application/javascript" --acl=public-read dist/mapbox-gl-instrumentile.min.js s3://mapbox-gl-js/plugins/mapbox-gl-instrumentile/$VERSION/mapbox-gl-instrumentile.js && \
